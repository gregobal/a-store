...
const products = [
    {id: 1, preview: "preview", title: "one", description: "", price: 100, availability: true, images: []},
    {id: 2, preview: "preview", title: "two", description: "", price: 200, availability: false, images: []}
];
